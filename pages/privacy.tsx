...
export default function Privacy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Winners List app</title>
      </Head>
      <div className="flex flex-col items-center min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-yellow-950">
        <h3 className="text-5xl text-white tracking-tight max-w-3xl font-semibold mt-10 mb-0">
        ...
        <p className="ml-5 text-gray-300 text-2xl max-w-4xl p-10">
          ...
          Terms and Conditions, which are accessible at Winners List unless
        ...
        <ul className="ml-5 text-gray-300 text-2xl max-w-4xl p-10">
        ...
        <p className="ml-5 text-gray-300 text-2xl max-w-4xl p-10">
          ...
          external sites are not operated by me. Therefore, I hereby advise you
        ...
        <p className="ml-5 text-gray-300 text-2xl max-w-4xl p-10">
          ...
          not hesitate to contact me at hey.amit@icloud.com.
        </p>
      </div>
    </>
  );
